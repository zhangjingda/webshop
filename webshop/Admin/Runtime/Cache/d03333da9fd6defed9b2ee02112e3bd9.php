...
<div class="left-side">
 <ul>
  ...
  <li class="left-side-i">未处理订单</li></a>
  <a href="__APP__/Order/hasOrder">
...
<div class="content-wrapper">
    ...
    <?php if(is_array($result)): $i = 0; $__LIST__ = $result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$re): $mod = ($i % 2 );++$i;?><div class="cont">
        ...
        <span class="tit">处理状态</span><span class="tip">已处理</span>
...
<script>
    ...
    (function(i){
            document.querySelectorAll(".page")[i].onclick = function(e){     
                ...
                window.location.href = "__APP__/Order/hasOrder/page/"+text
            }
    })(i)
  }
    ...
    (function(i){
            document.querySelectorAll(".page1")[i].onclick = function(e){
                ...
                ss = parseInt(ss.trim());
                if(i==0){
                    window.location.href = "__APP__/Order/hasOrder/page/"+(--ss) 
                }else if(i==1){
                    window.location.href = "__APP__/Order/hasOrder/page/"+(++ss)
                } 
            }
